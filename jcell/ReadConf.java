...
public class ReadConf {
	...
	protected boolean modeFlag = false;  // se for alterada para true, o formato da popula‹o que se encontra a ser utilizado Ž o de sqrt(V)
	
	/* Vari‡veis utilizadas somente no problema TOP-TW */
	...
	public EvolutionaryAlg getParameters(String dataFile, int genLimit) {
		...
		try
		{
			...
			{	
				...
				if(end < 0) {  // se a popula‹o estiver no formato sqrt(X)
